...
<footer id="colophon" class="bg-black mt-8">
    ...
    <div class="container px-4 mx-auto">
                    ...
                    <nav aria-label="<?php esc_attr_e('Footer Menu', 'pmstylesoup'); ?>" class="flex justify-center -mx-3 lg:-mx-6">
                        ...
                        wp_nav_menu(
                            array(
                                ...
                                'menu_class'     => 'footer-menu flex flex-wrap justify-center items-center gap-4',
                                'depth'          => 1,
                            )
                        );
                        ?>
        ...
        <?php else : ?>
            <div class="pt-4 pb-10 mx-auto max-w-4xl">
    ...
    <div class="flex items-center justify-center gap-x-5 ">
        <a href="" aria-label="Find us on LinkedIn" target="_blank" rel="noopener">
            <svg class="size-8 text-white" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="" aria-label="Find us on Twitter" target="_blank" rel="noopener">
            <svg class="size-8 text-white" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
