...
<?php if (!str_contains($current_url, $dashboard_url) || !is_account_page()) : ?>
    <div class="bg-cover bg-top bg-[url('<?php echo esc_url(get_image_path('images/Male-portrait-main-crop.jpg')); ?>')]" style="height: 434px !important;">
        <?php get_template_part('template-parts/layout/header', 'content'); ?>
        <section class="px-2 md:pl-12 bg-opacity-25 h-full pt-16 -mt-6">
            ...
            <p class="mt-20 md:max-w-2xl font-light md:text-gray-200 text-amber-700 text-sm flex items-center justify-start gap-2 hover:underline hover:text-white">
